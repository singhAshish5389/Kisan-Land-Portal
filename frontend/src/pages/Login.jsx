...
import { Landmark, Phone, Lock, Eye, EyeOff, Loader2 } from 'lucide-react';
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Basic Indian Mobile validation (typically 10 digits)
    ...
    <div className="min-h-[75vh] flex items-center justify-center px-4 py-8">
      <div className="bg-white p-8 md:p-10 rounded-3xl border border-emerald-100 shadow-md w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-3xl font-bold text-slate-800">Farmer Sign In</h2>
          <p className="text-slate-600 text-sm">
            Enter your mobile number and password to access saved plots.
          </p>
        </div>
